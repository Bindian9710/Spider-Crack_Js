function getPwd(pwd) {
    ...
    var m = i_217(e,t,i)
      , s = i_291(e,t,i)
      , y = {};
    y.NoPadding = "NoPadding",
    y.PKCS1Padding = "PKCS1Padding",
    y.RawEncoding = "RawEncoding",
    y.NumericEncoding = "NumericEncoding",
    t.RSAKeyPair = function o(e, t, i, n) {
        this.e = (0,
        m.biFromHex)(e),
        this.d = (0,
        m.biFromHex)(t),
        this.m = (0,
        m.biFromHex)(i),
        this.chunkSize = "number" != typeof n ? 2 * (0,
        m.biHighIndex)(this.m) : n / 8,
        this.radix = 16,
        this.barrett = new s.BarrettMu(this.m)
    }
    ,
    t.encryptedString = function b(e, t, i, n) {
        var s, o, a, r, l, c, u, d, p, h = new Array, f = t.length, g = "";
        for (r = "string" == typeof i ? i == y.NoPadding ? 1 : i == y.PKCS1Padding ? 2 : 0 : 0,
        l = "string" == typeof n && n == y.RawEncoding ? 1 : 0,
        1 == r ? f > e.chunkSize && (f = e.chunkSize) : 2 == r && f > e.chunkSize - 11 && (f = e.chunkSize - 11),
        s = 0,
        o = 2 == r ? f - 1 : e.chunkSize - 1; s < f; )
            r ? h[o] = t.charCodeAt(s) : h[s] = t.charCodeAt(s),
            s++,
            o--;
        for (1 == r && (s = 0),
        o = e.chunkSize - f % e.chunkSize; 0 < o; ) {
            if (2 == r) {
        ...
        h[e.chunkSize - 1] = 0),
        u = h.length,
        s = 0; s < u; s += e.chunkSize) {
            for (d = new m.BigInt,
            o = 0,
            a = s; a < s + e.chunkSize; ++o)
                d.digits[o] = h[a++],
                d.digits[o] += h[a++] << 8;
            p = e.barrett.powMod(d, e.e),
            g += 1 == l ? biToBytes(p) : 16 == e.radix ? (0,
            m.biToHex)(p) : biToString(p, e.radix)
        }
        return g
    };
    function i_217(e, t, i) {
        var n, v, u = 16, w = u, k = 65536, C = k >>> 1, $ = k * k, x = k - 1;
        function s(e) {
            n = new Array(e);
        ...
        function O(e) {
            var t, i = T(e), n = e.digits[i], s = (i + 1) * w;
        ...
        function p(e, t) {
            for (var i, n, s, o = new _, a = T(e), r = T(t), l = 0; l <= r; ++l) {
                ...
                for (var c = i = 0; c <= a; ++c,
                ++s)
                    n = o.digits[s] + e.digits[c] * t.digits[l] + i,
                    o.digits[s] = n & x,
                    i = n >>> u;
                o.digits[l + a + 1] = i
            }
        ...
        function h(e, t, i, n, s) {
            for (var o = Math.min(t + s, e.length), a = t, r = n; a < o; ++a,
            ++r)
                i[r] = e[a]
        }
        ...
        function V(e, t) {
            ...
            for (var s = t % w, o = w - s, a = n.digits.length - 1, r = a - 1; 0 < a; --a,
            --r)
                n.digits[a] = n.digits[a] << s & x | (n.digits[r] & f[s]) >>> o;
            return n.digits[0] = n.digits[a] << s & x,
            n.isNeg = e.isNeg,
            n
        }
        ...
        function I(e, t) {
            ...
            for (var s = t % w, o = w - s, a = 0, r = a + 1; a < n.digits.length - 1; ++a,
            ++r)
        ...
        function L(e, t) {
            var i = new _;
            return h(e.digits, 0, i.digits, t, i.digits.length - t),
            i
        }
        function M(e, t) {
            if (e.isNeg != t.isNeg)
        ...
        function m(e, t) {
            var i, n, s = O(e), o = O(t), a = t.isNeg;
            if (s < o)
                return e.isNeg ? ((i = S(v)).isNeg = !t.isNeg,
                e.isNeg = !1,
                t.isNeg = !1,
                n = A(t, e),
                e.isNeg = !0,
            ...
            n = V(n, l),
            s += l;
            for (var c = Math.ceil(s / w) - 1, u = L(t, c - r); -1 != M(n, u); )
                ++i.digits[c - r],
                n = A(n, u);
            for (var d = c; r < d; --d) {
                ...
                for (var y = i.digits[d - r - 1] * (g * k + m), b = p * $ + (h * k + f); b < y; )
                    --i.digits[d - r - 1],
                    y = i.digits[d - r - 1] * (g * k | m),
                    b = p * k * k + (h * k + f);
                (n = A(n, q(u = L(t, d - r - 1), i.digits[d - r - 1]))).isNeg && (n = j(n, u),
                --i.digits[d - r - 1])
            }
            return n = I(n, l),
            i.isNeg = e.isNeg != a,
            e.isNeg && (i = a ? j(i, v) : A(i, v),
            n = A(t = I(t, l), n)),
            0 == n.digits[0] && 0 == T(n) && (n.isNeg = !1),
            new Array(i,n)
        }
        t.setMaxDigits = s,
        t.biFromHex = function y(e) {
        ...
        t.biCopy = S,
        t.BigInt = _,
        t.biDivide = function b(e, t) {
            return m(e, t)[0]
        }
        ,
        t.biMultiply = p,
        t.biDivideByRadixPower = function F(e, t) {
            var i = new _;
            return h(e.digits, t, i.digits, 0, i.digits.length - t),
            i
        }
        ,
        t.biModuloByRadixPower = function P(e, t) {
            var i = new _;
            return h(e.digits, 0, i.digits, 0, t),
            i
        }
        ,
        t.biSubtract = A,
    ...
    function i_291(e, t, i) {
        ...
        function n(e) {
            var t = (0,
            c.biDivideByRadixPower)(e, this.k - 1)
              , i = (0,
            c.biMultiply)(t, this.mu)
              , n = (0,
            c.biDivideByRadixPower)(i, this.k + 1)
              , s = (0,
            c.biModuloByRadixPower)(e, this.k + 1)
              , o = (0,
            c.biMultiply)(n, this.modulus)
              , a = (0,
            c.biModuloByRadixPower)(o, this.k + 1)
              , r = (0,
            c.biSubtract)(s, a);
            r.isNeg && (r = biAdd(r, this.bkplus1));
            for (var l = 0 <= (0,
            c.biCompare)(r, this.modulus); l; )
                r = (0,
                c.biSubtract)(r, this.modulus),
                l = 0 <= (0,
                c.biCompare)(r, this.modulus);
            return r
        }
        function s(e, t) {
            var i = (0,
        ...
        function o(e, t) {
            var i = new c.BigInt;
            i.digits[0] = 1;
            for (var n = e, s = t; 0 != (1 & s.digits[0]) && (i = this.multiplyMod(i, n)),
            0 != (s = (0,
            c.biShiftRight)(s, 1)).digits[0] || 0 != (0,
            c.biHighIndex)(s); )
        ...
        t.BarrettMu = function a(e) {
            ...
            c.biCopy)(e),
            this.k = (0,
            c.biHighIndex)(this.modulus) + 1;
            var t = new c.BigInt;
            t.digits[2 * this.k] = 1,
            this.mu = (0,
            c.biDivide)(t, this.modulus),
            this.bkplus1 = new c.BigInt,
        ...
        ,
        t.BarrettMu_modulo = n,
        t.BarrettMu_multiplyMod = s,
        t.BarrettMu_powMod = o
    };
    return t;
}
