...
ab.prototype.nextBytes = _, db.prototype.doPublic = fb, db.prototype.setPublic = eb, db.prototype.encrypt = gb, RSAKey = db
...
function get_fingerPrint_and_fingerPrintDetail(a, b) {
    var c = '{"user_agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/79.0.3945.79","language":"zh-CN","color_depth":"24","pixel_ratio":"1","hardware_concurrency":"4","resolution":"1920,1080","available_resolution":"1920,1040","timezone_offset":"-480","session_storage":"1","local_storage":"1","indexed_db":"1","open_database":"1","cpu_class":"unknown","navigator_platform":"Win32","do_not_track":"unknown","regular_plugins":"Chrome PDF Plugin::Portable Document Format::application/x-google-chrome-pdf~pdf,Chrome PDF Viewer::","webgl_vendor":"Google Inc.~ANGLE (Intel(R) UHD Graphics 630 Direct3D11 vs_5_0 ps_5_0)","adblock":"true","has_lied_languages":"false","has_lied_resolution":"false","has_lied_os":"false","has_lied_browser":"false","touch_support":"0,false,false","js_fonts":"Arial,Arial Black,Arial Narrow,Book Antiqua,Bookman Old Style,Calibri,Cambria,Cambria Math,Century,C"}',
        d = "b383675ada1afe6160a1739883c49266",
        e = c.length,
        f = "",
        g = new RSAKey;
    g.setPublic(a,b);
...
var password = getPwd(a);

var fingerPrint_and_fingerPrintDetail = get_fingerPrint_and_fingerPrintDetail(a.result.modulus, a.result.publicExponent)